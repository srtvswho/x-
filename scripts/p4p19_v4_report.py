...
with open("/workspace/logs/p4p18_strict_verified.json") as f:
    d = json.load(f)
...
md = []
md.append(f"""# P4-19 报告: Jukan 记分牌 v4 (最严格修正) — 3 条 short 误抽 drop
...
# 写
out_path = "/workspace/outputs/phase4_p19_jukan_scoreboard_v4.md"
with open(out_path, "w") as f:
    f.writelines(md)
print(f"✅ saved {out_path}")
print()
print("--- P4-19 v4 关键 ---")
print("Drop 3 条 short: MU 6-26, AAPL 12-26, AAPL 12-13")
print("原 30 → 27 条")
print("raw 选股命中率 26/27 = 96.3%")
print("long 100% raw 涨 (26/26)")
print("他几乎从不做空 (1/27 = 3.7%)")
print("唯一留下 short: QCOM 5-22 (raw -14.3% 真亏, 但 vs SOXX hit)")
print()
print("跟单规则: 跟 long 全部 / 不跟 NVDA / 不跟搬运")