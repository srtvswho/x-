...
today_stats = bd.query_today_stats(con)
today_records = bd.query_today_records(con)
build_meta = bd.build_metadata(con)
...
call_performance = bd.query_call_performance(con)
