# P4-14 报告: Jukan 验证 — 他原创 vs 搬运机构观点 谁更准?

**生成时间**: 2026-06-23T02:34:49.388861
...
| 组 | 总数 | resolved | 无 ticker | 无 bars (海外) | 其他 |
|---|---|---|---|---|---|
...
### 5 大赢
- **Wed Dec 03** SNDK   long   90d: excess=+169.3% raw=+180.8%
  - 供应紧张和价格快速上涨趋势预计将持续至少3-5个月，利好SNDK。
- **Tue May 06** AMD    long  180d: excess=+96.4% raw=+158.7%
  - AMD is poised to gain market share in the inference chip segment due to competitive pricing and integrated inference-focused chips, especially if NVID
- **Wed Apr 15** MU     long  180d: excess=+67.8% raw=+114.7%
  - DRAM超级周期将持续，NVIDIA的VR300等产品将消耗大量LPDDR，导致短缺，利好DRAM制造商。
- **Wed Aug 27** ASML   long  180d: excess=+52.8% raw=+96.2%
  - TSMC's monopoly on foundry is weakening with Intel and Samsung emerging, so TSMC can no longer strong-arm ASML in EUV purchases, which will boost ASML
- **Mon Dec 30** MU     long  180d: excess=+35.7% raw=+46.4%
  - Memory suppliers can expect increased revenues and profits in 2H due to HBM ASP growth.

### 5 大输

- **2025-08-20** NVDA   long  180d: excess=-40.4% raw=+5.7%
  - Nvidia预订TSMC CoWoS产能以压制竞争对手，市场因谣言卖出是错误，未来Nvidia将控制供应并维持价格。
- **Tue Oct 28** NVDA   long  180d: excess=-42.5% raw=+4.6%
  - GPU capex 挤压人力支出，购买英伟达作为对冲软件工程师被挤出价值链的风险。
- **Thu May 22** QCOM   short 180d: excess=-53.3% raw=-14.3%
  - 小米自研芯片将压低高通芯片价格10-15%，影响高通营收，且高通估值过高。
- **Thu Apr 02** AAPL   long  180d: excess=-60.8% raw=+12.5%
  - Apple is aggressively buying up mobile DRAM to drive up prices and create shortages, preventing competitors from building devices, which will lead to 
- **Thu Jun 26** MU     short 180d: excess=-158.0% raw=-129.8%
  - Nvidia推迟2026年HBM供货合同谈判，试图等待三星通过验证以压低采购价格，对Micron的HBM业务造成负面影响。
